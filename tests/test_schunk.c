...
static char* test_schunk(void) {
  ...
  blosc2_add_umetalayer(schunk, "umetalayer1", (uint8_t *) "testing the umetalayers", 23);
  blosc2_add_umetalayer(schunk, "umetalayer2", (uint8_t *) "umetalayers", 11);
  ...
  // update metalayer
  blosc2_update_umetalayer(schunk, "umetalayer1", (uint8_t *) "testing the  umetalayers", 24);
  ...
  blosc2_get_umetalayer(schunk, "umetalayer1", &content2, &content2_len);
  mu_assert("ERROR: bad umetalayer content", strncmp((char*)content2, "testing the  umetalayers", content2_len) == 0);

  blosc2_get_umetalayer(schunk, "umetalayer2", &content2, &content2_len);
  mu_assert("ERROR: bad umetalayer content", strncmp((char*)content2, "umetalayers", content2_len) == 0);
  free(content2);
