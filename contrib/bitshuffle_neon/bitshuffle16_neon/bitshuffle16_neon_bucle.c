...
bitshuffle16_neon(const uint8_t* const src, uint8_t* dest, const size_t nbyte) {
  ...
  for (i = 0, k = 0; i < nbyte; i += 128, k++) {
    ...
    /*printf("\n");
    printmem8_l(vreinterpret_u8_u32(r2[0].val[0]));
    printmem8_l(vreinterpret_u8_u32(r2[0].val[1]));
    printmem8_l(vreinterpret_u8_u32(r2[1].val[0]));
    printmem8_l(vreinterpret_u8_u32(r2[1].val[1]));
    printmem8_l(vreinterpret_u8_u32(r2[2].val[0]));
    printmem8_l(vreinterpret_u8_u32(r2[2].val[1]));
    printmem8_l(vreinterpret_u8_u32(r2[3].val[0]));
    printmem8_l(vreinterpret_u8_u32(r2[3].val[1]));
    printmem8_l(vreinterpret_u8_u32(r2[4].val[0]));
    printmem8_l(vreinterpret_u8_u32(r2[4].val[1]));
    printmem8_l(vreinterpret_u8_u32(r2[5].val[0]));
    printmem8_l(vreinterpret_u8_u32(r2[5].val[1]));
    printmem8_l(vreinterpret_u8_u32(r2[6].val[0]));
    printmem8_l(vreinterpret_u8_u32(r2[6].val[1]));
    printmem8_l(vreinterpret_u8_u32(r2[7].val[0]));
    printmem8_l(vreinterpret_u8_u32(r2[7].val[1]));
    printf("\n");*/
    ...
    for (j = 0; j < 8; j++) {
      ...
      for(s = 0; s < 8; s++) {
        for(t = 0; t < 2; t++) {
          printf("r0[%d].val[%d] = ", s, t);
          printmem8_l(r0[s].val[t]);
        }
      }
      printf("\n");*/
...
main()
{
  ...
  size_t size = 512;
  bitshuffle16_neon(src, dest, size);
  printmem16(dest);
  printmem16(dest + 16);
  printmem16(dest + 32);
  printmem16(dest + 48);
