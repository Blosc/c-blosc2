...
#define BLOSC2_VERSION_MINOR    7    /* for minor interface/format changes  */
#define BLOSC2_VERSION_RELEASE  2    /* for tweaks, bug-fixes, or development */

#define BLOSC2_VERSION_STRING   "2.7.2.dev"  /* string version.  Sync with above! */
#define BLOSC2_VERSION_DATE     "$Date:: 2023-02-22 #$"    /* date version */
