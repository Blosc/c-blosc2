...
The trailer for the frame is encoded via `msgpack <https://msgpack.org>`_ and contains dynamic metalayers and a
fingerprint.::
        ...
        +--------+--------+--------+--------+========+--------+--------+--------+--------+--------+~~~~~~~~~~~~~~~~~~+
    ... |  0xde  |XXXXXXXX|XXXXXXXX|101XXXXX|  data  |  0xd2  |ZZZZZZZZ|ZZZZZZZZ|ZZZZZZZZ|ZZZZZZZZ|  repeat N-times  |
        +--------+--------+--------+--------+========+--------+--------+--------+--------+--------+~~~~~~~~~~~~~~~~~~+
        ^                          ^                 ^                                            ^
